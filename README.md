...
<body>
    ...
    <section class="section" id="trabajos">
        ...
        <div class="trabajos-grid">
            <div class="trabajo-card">
                <img src="https://images.unsplash.com/photo-1593967645659-05209301264e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80" alt="Instalación Eléctrica Residencial" class="trabajo-img">
            ...
            <div class="trabajo-card">
                <img src="https://images.unsplash.com/photo-1605130284535-5f9856f3219d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80" alt="Mantenimiento Industrial" class="trabajo-img">
                <div class="trabajo-content">
            ...
            <div class="trabajo-card">
                <img src="https://images.unsplash.com/photo-1585076641399-5c06d1b38236?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80" alt="Iluminación Pública" class="trabajo-img">
                <div class="trabajo-content">
    ...
    <section class="section" id="contacto">
        ...
        <div class="contacto-container">
            <img src="https://images.unsplash.com/photo-1555041469-a586c61ea9bc?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80" alt="Contacto Eléctrico" class="contacto-img">
            <div class="contacto-info">
                ...
                <p><i class="fas fa-map-marker-alt"></i> Ubicación: Ciudad Autónoma de Buenos Aires, Argentina</p>
                <p><i class="fas fa-clock"></i> Horario de Atención: Lunes a Viernes de 8:00 a 18:00 hs</p>
                <p><i class="fas fa-phone"></i> Consultas Urgentes: WhatsApp flotante o llamada directa</p>
            </div>
        </div>
    </section>
